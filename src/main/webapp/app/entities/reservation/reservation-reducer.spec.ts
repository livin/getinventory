...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESERVATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESERVATION actions', async () => {
      const expectedActions = [
        {
