...
export const InventoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="getinventoryApp.inventory.delete.question">Are you sure you want to delete Inventory {inventoryEntity.id}?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-inventory" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
