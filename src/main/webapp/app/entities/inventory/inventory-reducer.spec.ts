...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './inventory.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVENTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVENTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVENTORY actions', async () => {
      const expectedActions = [
        {
